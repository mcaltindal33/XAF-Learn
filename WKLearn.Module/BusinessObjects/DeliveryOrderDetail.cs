...
namespace WKLearn.Module.BusinessObjects
{
    ...
    public class DeliveryOrderDetail : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public DeliveryOrderDetail(Session session)
            : base(session)
        {
        }
        ...
        [Browsable(false)]
        [Association("DeliveryOrder-OrderDetail", typeof(DeliveryOrder))]
        public DeliveryOrder SalesOrder
        {
            get
            {
                return salesOrder;
